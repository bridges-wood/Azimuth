...
public class Player extends Character implements Serializable{
	...
	public Player(String name, int exp, int level, int hp, int credits, Apparel[] armour, int[] resistances,
		...
		chosen difficulty setting during play-throughs. Max 17/11/18*/
		...
		Skill Hacking = new Skill("Hacking", "Affects the player's ability to break into and use hostile computer systems.",temp);
		Skill Medicine = new Skill("Medicine", "Affects the player's ability to use medical equipment as well as perform triage "
				+ "and other medical tasks.", temp);
		temp = (this.getREPLICAS()[4] * 20);
		Skill AdvancedWeapons = new Skill("Advanced Weapons Training", "Affects the player's ability to use more advanced weapons",temp);
		Skill[] skillsArr = new Skill[] {Persuasion, Hacking, Medicine, AdvancedWeapons}; //Other skills could be added in the future, open to ideas. Max 17/11/18
